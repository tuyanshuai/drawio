...
Sidebar.prototype.init = function()
{
	...
	// this.addSearchPalette(true); // Disabled - only keeping General and Isometric palettes
	...
	//	';whiteSpace=wrap;html=1;fillColor=#ffffff;strokeColor=#000000;strokeWidth=2'); // Disabled - only keeping General and Isometric palettes
	// this.setCurrentSearchEntryLibrary(); // Disabled - only keeping General and Isometric palettes
	
	// this.addUmlPalette(false); // Disabled - only keeping General and Isometric palettes
	// this.addBpmnPalette(dir, false); // Disabled - only keeping General and Isometric palettes
	
	// this.setCurrentSearchEntryLibrary('flowchart'); // Disabled - only keeping General and Isometric palettes
	// this.addStencilPalette('flowchart', 'Flowchart', dir + '/flowchart.xml',
	//	';whiteSpace=wrap;html=1;fillColor=#ffffff;strokeColor=#000000;strokeWidth=2'); // Disabled - only keeping General and Isometric palettes
	// this.setCurrentSearchEntryLibrary(); // Disabled - only keeping General and Isometric palettes
	
	// this.setCurrentSearchEntryLibrary('clipart'); // Disabled - only keeping General and Isometric palettes
	...
	//	  'Router_Icon': 'router switch'}); // Disabled - only keeping General and Isometric palettes
	// this.setCurrentSearchEntryLibrary(); // Disabled - only keeping General and Isometric palettes
};
