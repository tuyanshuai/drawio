...
(function()
{
    ...
    if (mxIsElectron)
    {
        mxmeta(null, 'default-src \'self\'; script-src \'self\' \'sha256-6g514VrT/cZFZltSaKxIVNFF46+MFaTSDTPB8WfYK+c=\' ' +
            ...
            'connect-src \'self\' https://*.draw.io https://*.diagrams.net https://fonts.googleapis.com https://fonts.gstatic.com http://127.0.0.1:8089 http://localhost:8089 http://127.0.0.1 http://localhost; ' +
