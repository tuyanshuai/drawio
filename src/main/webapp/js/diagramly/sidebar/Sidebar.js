...
(function()
{
	...
	Sidebar.prototype.initPalettes = function()
	{
		...
		{
			// this.addCustomEntries(); // Disabled - only keeping General and Isometric palettes
		}
		...
		// this.addArrows2Palette(); // Disabled - only keeping General and Isometric palettes
		
		// All clipart palettes disabled - only keeping General and Isometric palettes
		...
		// All other palettes disabled - only keeping General and Isometric palettes
